...
vectorMapWorldMarkersColors && (worldemapmarkers = new jsVectorMap({
    ...
    markers: [{
        ...
        style: {
            image: "/backend/assets/images/flags/us.svg"
        }
    }, {
        name: "Russia",
        coords: [61.524, 105.3188],
        style: {
            image: "/backend/assets/images/flags/russia.svg"
        }
    }, {
        name: "Spain",
        coords: [40.4637, 3.7492],
        style: {
            image: "/backend/assets/images/flags/spain.svg"
        }
    }, {
        name: "Italy",
        coords: [41.8719, 12.5674],
        style: {
            image: "/backend/assets/images/flags/italy.svg"
        }
    }, {
        name: "Germany",
        coords: [51.1657, 10.4515],
        style: {
            image: "/backend/assets/images/flags/germany.svg"
        }
    }],
    markerStyle: {
        initial: {
